...
async def create_game(game: Game):
    ...
    try:
        sql="INSERT INTO GameTable (market,symbol,date,price,direct) value(%s,%s,%s,%s,%s)"
        value=(game.market,game.symbol,game.date.date(),float(game.target),game.direction)
